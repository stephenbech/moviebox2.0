    ...
    <div className="movie-slider">
      ...
      {currentMovie && (
        <div className="movie-details">
          <img alt='poster' src={`https://image.tmdb.org/t/p/original/${currentMovie.poster_path}`} data-testid='poster' className='absolute inset-0 -z-10 h-full  w-full object-cover'/>
          <div className="font w-96 ml-6 mt-14 lg:mt-36 lg:mx-40  flex-col justify-start items-start gap-4 inline-flex">
            <div className="font w-72 sm:w-96 text-white font text-5xl font-bold leading-10">{currentMovie.title}</div>
