            ...
            <div className='flex space-x-5'>
              ...
              <div className='block h-screen'>
                      ...
                      <div className='sm:flex  mt-40'>
                            ...
                            <h2 className='text-neutral-700 sm:text-xl w-80 font-bold'>Release Date: {movie.release_date}</h2>
                            <span className='hidden sm-inlineflex rounded-full  h-1 w-1 mt-3 ml-2 mr-2 bg-gray-700'></span>

                            <h2 data-testid="movie-runtime" className='text-neutral-700 w-80 sm:text-xl font-bold'>Runtime: {movie.runtime} Minutes</h2>
                      </div> 
