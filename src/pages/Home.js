...
import {baseUrl, requests} from '../utilities/request';
  ...
  return (
    <div className='block '>
                  ...
                  <div>
                        ...
                        <div className=' flex flex-nowrap justify-between px-4  mt-5'>
                        ...
                        <div className='absolute w-11/12 mx-3 lg:mx-14  top-full'>
                              ...
                              <div className="Footer mt-20 w-full flex-col inline-flex items-center gap-9 ">
                                    ...
                                    <div className="font text-gray-500 text-lg font-bold">© 2024 MovieBox by bechtech  </div>
                              </div>
                        </div>
                  </div>
